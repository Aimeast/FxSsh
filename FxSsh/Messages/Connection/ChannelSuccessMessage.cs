...
{
    /// <summary>
    /// Represents the SSH_MSG_CHANNEL_SUCCESS message (RFC 4254 section 5.4),
    /// the positive reply to a channel request that asked for a reply.
    /// </summary>
    ...
    public class ChannelSuccessMessage : ConnectionServiceMessage
    {
        ...
        /// <summary>Gets the message number that identifies this message as SSH_MSG_CHANNEL_SUCCESS.</summary>
